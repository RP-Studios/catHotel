...
namespace CatHotel.Core
{
    ...
    public static class LocalizedStrings
    {
        ...
        public static readonly Dictionary<string, string> French = new()
        {
            ...
            { "tuto.floors", "L'hôtel a <b>plusieurs étages</b>. Plus votre réputation augmente, plus vous débloquerez d'étages. Certains chats exigeront des objets en hauteur !" },
            { "tuto.coins", "La monnaie ici est le <b>Cat Coin</b>. Achetez des objets pour que vos chats puissent manger, boire, dormir... Il en faudra beaucoup pour débloquer les étages !" },
        ...
        public static readonly Dictionary<string, string> English = new()
        {
            ...
            { "tuto.floors", "The hotel has <b>multiple floors</b>. The higher your reputation, the more floors you'll unlock. Some cats will demand items on upper floors!" },
            { "tuto.coins", "The currency here is the <b>Cat Coin</b>. Buy items so your cats can eat, drink, sleep... You'll need plenty to unlock new floors!" },

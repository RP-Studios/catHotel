...
namespace CatHotel.Core
{
    ...
    public static class LocalizedStrings
    {
        ...
        public static readonly Dictionary<string, string> French = new()
        {
            ...
            { "tuto.hud.comfort", "Le <b>confort moyen</b> de l'hôtel. Démarre à 50%, augmente avec les objets de décoration que vous placez. Chute si l'hôtel est trop rempli (>80%)." },
        ...
        public static readonly Dictionary<string, string> English = new()
        {
            ...
            { "tuto.hud.comfort", "The hotel's <b>average comfort</b>. Starts at 50%, increases with decoration items you place. Drops if the hotel gets too crowded (>80%)." },
